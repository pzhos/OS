...
int main() {
    ...
    HANDLE inputSemaphore = CreateSemaphore(NULL, 0, number_of_notes, "EnterSemaphoreStarted");
    if (inputSemaphore == NULL)
        return GetLastError();
    HANDLE outputSemaphore = CreateSemaphore(NULL, 0, number_of_notes, "OutputSemaphoreStarted");
